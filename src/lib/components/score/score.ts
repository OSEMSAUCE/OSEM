// Score algorithm — uses shared config from scoreCore.ts
...
// Re-export everything from scoreCore so existing consumers don't break
export { relevantTables, scoreMatrix, ignoreList, polygonCalc, scoreRecord, polymorphicTables, DEFAULT_ATTRIBUTE_SCORE } from "./scoreCore";
export type { RecordScore, ProjectScoreResult, ScoreBreakdown, RelevantTable } from "./scoreCore";
