<script lang="ts">
	...
	import { initializeOrgMap } from '$lib/subwoof/components/map/orgMapParent';
...
<div class="flex h-screen w-full flex-col md:flex-row">
	<!-- Sidebar List -->
	<div class="w-full md:w-1/3 lg:w-1/4 h-1/2 md:h-full overflow-y-auto border-r border-gray-200 bg-white dark:bg-gray-900 dark:border-gray-800">
